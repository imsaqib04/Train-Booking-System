...
public class TrainResponseDTO {
    ...
    // nested station list
    private List<IntermediateStationDTO> intermediateStations;
    ...
    public List<IntermediateStationDTO> getIntermediateStations() {
        return intermediateStations;
    }

    public void setIntermediateStations(List<IntermediateStationDTO> intermediateStations) {
